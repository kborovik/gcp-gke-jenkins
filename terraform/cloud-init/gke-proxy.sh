...
/usr/local/openvpn_as/scripts/sacli --key "vpn.server.dhcp_option.domain" --value "krcmar.az" ConfigPut
/usr/local/openvpn_as/scripts/sacli --key "vpn.server.dhcp_option.adapter_domain_suffix" --value "krcmar.az" ConfigPut
